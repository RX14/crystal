...
module Crystal::System::File
  # Open the file at *filename* with open mode *mode*. If a new file is created,
  # create it with permissions *perm*.
  # def self.open(filename : String, mode : String, perm : Int32)

  # Creates a
  # def self.mktemp(name, extension) : {FD, String}
